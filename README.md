...
This project focuses solely on the critical initial steps of the data science lifecycle: data cleaning, exploration, and preprocessing. The goal is to transform a raw loan dataset into a clean, structured, and analysis-ready format, suitable for subsequent machine learning model.
